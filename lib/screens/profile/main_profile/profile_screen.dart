...
class ProfileScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MultiProvider(
      ...
      child: Consumer2<ProfileViewModel, EditProfileViewModel>(
        builder: (context, value, editModel, child) => Scaffold(
          appBar: CustomAppBar(
            title: 'Profile',
                ...
                child: RefreshIndicator(
                  onRefresh: () async {
                    final Map<String, dynamic> data = {
                      'name': editModel.nameController.text.trim(),
                      'email': editModel.emailController.text.trim(),
                      'phoneNumber': editModel.phoneController.text.trim(),
                      'description':
                          editModel.descriptionController.text.trim(),
                      // Note: image uploading to storage is not handled here.
                    };
                    await editModel.updateCurrentUserData(data);
                  },
                  child: Column(
